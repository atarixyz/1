...
repeat
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'ata<font color="rgb(229, 215, 215)">ri</font> - uid: <font color="rgb(229, 215, 215)">' .. uid .. '</font> / fps: <font color="rgb(229, 215, 215)">' .. fpsValue .. '</font> / ping: <font color="rgb(229, 215, 215)">' .. ping .. '</font> / time: <font color="rgb(229, 215, 215)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'ata<font color="rgb(107, 100, 100)">ri</font>',
        ...
        function library:Notify(Text, Time)
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("atari/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("atari") do table.insert(tbl,v) end
